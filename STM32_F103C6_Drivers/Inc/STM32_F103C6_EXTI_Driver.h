...
#ifndef INC_DRIVER_STM32_F103C6_EXTI_DRIVER_H_
#define INC_DRIVER_STM32_F103C6_EXTI_DRIVER_H_
...
typedef struct{
	uint16_t 			EXTI_InputLineNumber;  //lines: 0->15
...
#endif /* INC_DRIVER_STM32_F103C6_EXTI_DRIVER_H_ */
