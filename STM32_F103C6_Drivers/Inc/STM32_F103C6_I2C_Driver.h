...
//==============================================NOTE: this driver support slave interrupt mech and master polling mech.===============/
...
typedef enum
{
	...
	I2C_ERROR_AF ,
	I2C_EV_ADDR_Matched,
	I2C_EV_DATA_REQ  ,//the APP layer should send the data (MCAL_I2C_SlaveSendData ) in this state
	I2C_EV_DATA_RCV  //the APP layer should read the data (MCAL_I2C_SlaveReceiveData ) in this state
} Slave_State;
...
#define I2C_SCLK_SM_100K  				(100000U)		//you can add any value lower than 100k in sm mode
